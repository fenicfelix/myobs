...
class grocery_CRUD_Layout extends grocery_CRUD_Model_Driver
{
	...
	protected function get_date_input($field_info,$value)
	{
		...
		/*$input = '<div id="date-popup" class="input-group date"> 
			<input type="text" data-format="D, dd MM yyyy" class="form-control"> 
			<span class="input-group-addon"><i class="fa fa-calendar"></i></span> 
		</div>';*/
		
		$input = '<div id="date-popup" class="input-group date"> 
					<input type="text" id="field-'.$field_info->name.'" name="'.$field_info->name.'" value="'.$date.'" data-format="D, dd MM yyyy" class="form-control datepicker-input"> 
					<span class="input-group-addon"><i class="fa fa-calendar"></i></span> 
				</div>';
	...
	protected function get_dropdown_input($field_info,$value)
	{
		...
		$input = "<select id='field-{$field_info->name}' name='{$field_info->name}' class='chosen-select col-lg-3 col-md-6 col-sm-12' data-placeholder='".$select_title."'>";
	...
	protected function get_readonly_input($field_info, $value)
	{
		...
		//return '<input id="field-'.$field_info->name.'" class="form-control" type="text" value="'.$read_only_value.'" maxlength="50" readonly>';
