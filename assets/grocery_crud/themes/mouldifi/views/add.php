...
$this->set_js_lib($this->default_theme_path.'/mouldifi/js/mouldifi-add.js');
	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading clearfix">
				<h3 class="panel-title"><?php echo $this->l('form_add'); ?> <?php echo $subject?></h3>
			...
			<div class="panel-body">
				...
				<div class="form-group">
					<div class="col-sm-10 col-sm-offset-2">
						<button class="btn btn-primary" id="form-button-save" type="submit"><?php echo $this->l('form_save'); ?></button>
						<?php 	if(!$this->unset_back_to_list) { ?>
							<button class="btn btn-primary" id="save-and-go-back-button" type="button"><?php echo $this->l('form_save_and_go_back'); ?></button>
